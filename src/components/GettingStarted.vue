<template lang="">
    <section class="flex gap-8 relative">
        <div class="flex-1">
        ...
        <div
            class="py-4 w-[11rem] h-min max-h-5xl sticky top-[0rem] text-sm hidden md:block"
        >
...
<script>
import Code from "@/components/container/Code.vue";
...
export default {
    ...
    mounted() {
        document
            .querySelectorAll('.nav-panel a[href^="#"]')
            .forEach((anchor) => {
...
ul,
ol {
    @apply my-6 leading-6 text-darkGray text-sm;
}
